document.addEventListener("DOMContentLoaded", function () {
  ...
  // --------------- IRIS VIDEO BUTTON ---------------
  function irisVideoBtn() {
    const btn = document.querySelector("[data-btn='iris-video']");
    const modalTrigger = document.querySelector(".c-video-contain.assist-page");
    const videoSection = document.querySelector("#iris-video-section");
